...
let tasks = [{ id: 1, title: 'cleaning', description: 'kitchen', status: 'pending' }, { id: 1, title: 'cleaning', description: 'kitchen', status: 'pending' }, { id: 1, title: 'cleaning', description: 'kitchen', status: 'pending' }, { id: 1, title: 'cleaning', description: 'kitchen', status: 'pending' }, { id: 1, title: 'cleaning', description: 'kitchen', status: 'pending' }, { id: 2, title: 'errands', description: 'afternoon', status: 'pending' }];
let task;
app.get('/', (req, res) => {
